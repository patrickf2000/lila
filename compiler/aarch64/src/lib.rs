...
fn write_code(writer : &mut BufWriter<File>, code : &Vec<LtacInstr>) {
    ...
    for code in code.iter() {
        match &code.instr_type {
            ...
            LtacType::LdArgI32 | LtacType::LdArgU32 => aarch64_build_ldarg(writer, &code, stack_size),
            LtacType::LdArgF32 => {},
            LtacType::LdArgF64 => {},
